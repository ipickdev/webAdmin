...
/**
 * This is the page for creating a new driver
 */
export const NewDriver = () => {
  ...
  // submit the form data to the server for creating a new driver
  ...
  const getMeAnID = async () => {
    ...
    do {
      id = makeid(10);
      testCollision = await apiService.get(`auth/checkid/driver/${id}`);
    }while(testCollision);
    return id;
  }
    ...
    <section className="page new-driver">
      ...
      <form onSubmit={handleSub}>
        ...
        <span className="item">
          ...
          <input type="text" name='plateNum' id="plateNum" placeholder='ABC123' required maxLength={10}/>
        </span>
        <span className="item">
